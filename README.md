...
- [SimpleBackups](https://simplebackups.com/mysql-backup/) - Backup as a Service for MySQL - leverage mydumper & mysqldump with tooling, scheduling and anomaly detection
